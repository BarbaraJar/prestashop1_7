...
//namespace PrestaShop\PrestaShop\Core\Paysera;
//use PrestaShop\PrestaShop\Core\Paysera\PaymentOption;
	...
	public function hookPaymentOptions()
	{
		...
		$this->smarty->assign(array(
			...
			'this_path_ssl' => (Configuration::get('PS_SSL_ENABLED') ? 'https://' : 'http://').
				htmlspecialchars($_SERVER['HTTP_HOST'], ENT_COMPAT, HTML).__PS_BASE_URI__.'modules/'.$this->name.'/'
		));
