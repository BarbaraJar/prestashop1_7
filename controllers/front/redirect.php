...
class PayseraRedirectModuleFrontController extends ModuleFrontController {
	...
	public function initContent()
	{
		...
		$this->module->validateOrder($cart->id, Configuration::get('PAYSERA_PENDING'), $total, $this->module->displayName, null, null, $currency->id, false, $this->context->cart->secure_key);
